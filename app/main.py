...
from app.data_dashboard import build_data_dashboard, dashboard_roles_payload
from app.rag_service import call_direct_rag, direct_backend_configured, execute_sql as execute_databricks_sql
...
ROLE_ROWS = [('COMPLIANCE_MANAGER',
  'Compliance Manager',
  'Compliance and audit log management',
  'RESTRICTED',
  'Compliance',
  ['QMS', 'GROUPWARE'],
  ['Legal/Compliance', 'Quality/RA', 'Audit'],
  ['cos_adb.silver.legal_compliance_audit_log',
   ...
   'cos_adb.silver.fin_tax_documents_metadata',
   'cos_adb.governance.role_change_history']),
 ('CS_STAFF',
  'CS Staff',
  'Customer inquiry and response manual management',
  'CONFIDENTIAL',
  'CS',
  ['CRM', 'GROUPWARE'],
  ['Customer Service', 'VOC', 'Event'],
  ['cos_adb.silver.cs_customer_inquiries', 'cos_adb.silver.voc_review_voc_insights']),
 ('EXECUTIVE',
  'Executive',
  'Company KPI, strategy, and investment decisions',
  'RESTRICTED',
  'Executive',
  ['ERP', 'QMS', 'PLM', 'GROUPWARE'],
  ['Executive', 'Finance', 'Marketing', 'Quality/RA', 'R&D/Product'],
 ...
 ('FINANCE_MANAGER',
  'Finance Manager',
  'Tax, budget, and investment material approval',
  'RESTRICTED',
  'Finance',
  ['ERP'],
  ['Finance', 'SCM', 'Distribution'],
  ['cos_adb.silver.fin_sales_summary',
   'cos_adb.silver.fin_budget_plan',
 ...
 ('FINANCE_STAFF',
  'Finance Staff',
  'Expense, budget, and sales aggregation',
  'CONFIDENTIAL',
  'Finance',
  ['ERP'],
  ['Finance'],
  ['cos_adb.silver.fin_sales_summary', 'cos_adb.silver.fin_expense_records']),
 ('GENERAL_EMPLOYEE',
  'General Employee',
  'Internal notice and allowed department material access',
  'INTERNAL',
  'General',
  ['GROUPWARE'],
  ['Event', 'Notice'],
  ['cos_adb.silver.events', 'cos_adb.search.llm_table_context']),
 ('HR_MANAGER',
  'HR Manager',
  'HR approval, evaluation, and privacy control',
  'RESTRICTED',
  'HR',
  ['HRIS', 'IAM'],
  ['HR', 'IT', 'Governance'],
  ['cos_adb.silver.employees', 'cos_adb.silver.hr_payroll_summary', 'cos_adb.silver.roles', 'cos_adb.silver.systems']),
 ('HR_STAFF',
  'HR Staff',
  'HR operations, attendance, and training data handling',
  'CONFIDENTIAL',
  'HR',
  ['HRIS'],
  ['HR', 'Training'],
  ['cos_adb.silver.employees', 'cos_adb.silver.hr_payroll_summary']),
 ('IT_ADMIN',
  'IT Admin',
  'IAM, account, and permission management',
  'RESTRICTED',
  'IT',
  ['IAM', 'GROUPWARE'],
  ['IAM', 'Security', 'Governance'],
  ['cos_adb.governance.rag_identity_map', 'cos_adb.governance.role_change_history', 'cos_adb.governance.access_policies']),
 ('LEGAL_STAFF',
  'Legal Staff',
  ...
  ['GROUPWARE'],
  ['Legal/Compliance'],
  ['cos_adb.silver.legal_contract_metadata', 'cos_adb.silver.legal_regulatory_documents']),
 ('MARKETING_STAFF',
  'Marketing Staff',
  'Campaign, ad copy, and launch schedule management',
  'DEPARTMENT',
  'Marketing',
  ['ERP', 'GROUPWARE'],
  ['Marketing', 'VOC', 'Event'],
 ...
 ('PAYROLL_MANAGER',
  'Payroll Manager',
  'Payroll summary and compensation data handling',
  'RESTRICTED',
  'HR',
  ['HRIS'],
  ['Payroll', 'HR'],
  ['cos_adb.silver.hr_payroll_summary', 'cos_adb.silver.compensation_adjustments']),
 ('PRODUCTION_MANAGER',
  'Production Manager',
  'Production planning and work approval',
  'CONFIDENTIAL',
  'Production',
  ['MES', 'ERP'],
  ['Manufacturing', 'SCM'],
 ...
 ('PRODUCTION_STAFF',
  ...
  ['MES'],
  ['Manufacturing'],
  ['cos_adb.silver.mfg_work_orders', 'cos_adb.silver.mfg_batch_manufacturing_records']),
 ('QA_MANAGER',
  'QA Manager',
  'Quality approval and audit response',
  'RESTRICTED',
  'QA',
  ['QMS', 'LIMS', 'GROUPWARE'],
  ['Quality/RA', 'Manufacturing', 'Event'],
  ['cos_adb.silver.qa_deviation_reports',
   'cos_adb.silver.qa_capa_records',
   'cos_adb.silver.qa_qc_test_results',
   'cos_adb.silver.voc_review_voc_insights',
 ...
 ('QA_STAFF',
  'QA Staff',
  'Quality documents, deviation, and CAPA management',
  'CONFIDENTIAL',
  'QA',
  ['QMS'],
  ['Quality/RA'],
  ['cos_adb.silver.qa_deviation_reports', 'cos_adb.silver.qa_capa_records']),
 ('QC_ANALYST',
  'QC Analyst',
  'Test result and LIMS record management',
  'CONFIDENTIAL',
  'QC',
  ['LIMS', 'QMS'],
  ['Quality/RA'],
  ['cos_adb.silver.qa_qc_test_results', 'cos_adb.silver.lims_test_records']),
 ('RA_MANAGER',
  'RA Manager',
  'Regulatory risk and certification document approval',
  'RESTRICTED',
  'RA',
  ['QMS', 'GROUPWARE'],
  ['Legal/Compliance', 'Quality/RA'],
  ['cos_adb.silver.ra_certification_documents', 'cos_adb.silver.regulatory_risk_register']),
 ('RA_STAFF',
  'RA Staff',
  'Labeling, advertising, and regulatory review',
  'CONFIDENTIAL',
  'RA',
  ['QMS', 'GROUPWARE'],
  ['Legal/Compliance', 'Marketing'],
  ['cos_adb.silver.ra_labeling_review', 'cos_adb.silver.marketing_claim_review']),
 ('RND_MANAGER',
  'R&D Manager',
  'Research task and formula approval',
  'RESTRICTED',
  'R&D',
  ['PLM', 'QMS'],
  ['R&D/Product', 'Quality/RA'],
  ['cos_adb.silver.rnd_product_master',
   'cos_adb.silver.rnd_product_improvement_actions',
   'cos_adb.silver.voc_review_voc_insights',
   'cos_adb.silver.scm_raw_material_inventory',
 ...
 ('RND_RESEARCHER',
  'R&D Researcher',
  'Product planning, formula development, and test records',
  'CONFIDENTIAL',
  'R&D',
  ['PLM', 'QMS'],
  ['R&D/Product', 'Quality/RA'],
  ['cos_adb.silver.rnd_product_master', 'cos_adb.silver.rnd_product_improvement_actions', 'cos_adb.silver.qa_qc_test_results']),
 ('SCM_MANAGER',
  'SCM Manager',
  'Supplier and inventory policy approval',
  'CONFIDENTIAL',
  'SCM',
  ['ERP', 'MES'],
  ['SCM', 'Distribution', 'Manufacturing'],
  ['cos_adb.silver.scm_supplier_master',
   'cos_adb.silver.scm_raw_material_inventory',
   'cos_adb.silver.scm_purchase_orders',
   'cos_adb.silver.scm_delivery_schedule',
 ...
 ('SCM_STAFF',
  'SCM Staff',
  'Purchase order, inventory, and logistics schedule management',
  'CONFIDENTIAL',
  'SCM',
  ['ERP'],
  ['SCM', 'Distribution'],
  ['cos_adb.silver.purchase_orders', 'cos_adb.silver.inventory_transactions', 'cos_adb.silver.distribution_schedule']),
 ('TRAINING_MANAGER',
  'Training Manager',
  'Training completion, certification, and required education management',
  'CONFIDENTIAL',
  'Training',
  ['HRIS', 'GROUPWARE'],
  ['Training', 'HR'],
  ['cos_adb.silver.training_completion_records', 'cos_adb.silver.employee_certifications'])]
...
@app.get("/api/admin/data-dashboard/roles")
def data_dashboard_roles():
    return {
        "roles": dashboard_roles_payload(ROLE_ACCESS),
        "databricks_sql_configured": direct_backend_configured(),
        "required_env": [
            "DATABRICKS_SQL_WAREHOUSE_ID or DATABRICKS_WAREHOUSE_ID",
            "DATABRICKS_HOST and DATABRICKS_TOKEN for local execution only",
        ],
    }


@app.get("/api/admin/data-dashboard/{role_id}")
def data_dashboard(role_id: str):
    return build_data_dashboard(
        role_id=role_id,
        role_access=ROLE_ACCESS,
        execute_sql=execute_databricks_sql,
        configured=direct_backend_configured(),
    )
